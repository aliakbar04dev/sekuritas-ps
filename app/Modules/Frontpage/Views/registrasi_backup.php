                                ...
                                <div class="row">
                                    ...
                                    <?php if(!empty($referal_id)): ?>
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="referal_id" value="<?= $referal_id ?>" class="form-control" readonly>
                        ...
                        <div class="col-8">
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center">
                                    <div class="g-recaptcha" data-sitekey="6Lefe_YgAAAAAIV2NPykoaH9tsb0QAVfM1rEf-k2" data-callback="successCaptcha" data-expired-callback="reloadPage" data-error-callback="reloadPage"></div>
                                </div>
                                <div class="col-md-12 text-center">
                                    <div id="recaptcha-error" style="color:red"></div>
                                </div>
                                <div class="col-md-12 mt-3 mb-4 text-center">
                                    <button id="btn-submit"  class="btn btn-warning pl-4 pr-4" style=" border:none;"><font class="tebel putih" style="font-size: 22px;">DAFTAR SEKARANG!</font> <br> <font class="putih" style="font-size: 13px;">Lanjut Membuka Rekening Saham!</font></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-2"></div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#register-form').on('submit', function(e){
            ...
            if(recaptchaResp == ''){
                $('#recaptcha-error').html('Anda Belum Mengisi Captcha');
                return false;
            }
            return false;
            let result = $(this).submitAjax('#'+id, e);
