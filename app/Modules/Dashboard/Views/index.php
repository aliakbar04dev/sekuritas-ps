...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid mt-5 mb-3">
    <div class="row">
        <div class="col-12">
                    ...
                    <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                            <h3 class="kt-iconbox__title">
                                <a class="kt-link" href="#" style="font-size: 14px;">Member</a>
                            </h3>
                            <div class="kt-iconbox__content">
                                <H5 class="text-dark"><?= @number_format($count_customer, 0) ?></H5>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="kt-portlet kt-iconbox kt-iconbox--warning  kt-iconbox--animate">
                <div class="kt-portlet__body">
                    <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                            <h3 class="kt-iconbox__title">
                                <a class="kt-link" href="#" style="font-size: 14px;">Content</a>
                            </h3>
                            <div class="kt-iconbox__content">
                                <H5 class="text-dark"><?= @number_format($count_content, 0) ?></H5>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="kt-portlet kt-iconbox kt-iconbox--warning  kt-iconbox--animate">
                <div class="kt-portlet__body">
                    <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                            <h3 class="kt-iconbox__title">
                                <a class="kt-link" href="#" style="font-size: 14px;">Subscriber</a>
                            </h3>
                            <div class="kt-iconbox__content">
                                <H5 class="text-dark"><?= @number_format($count_subscribers, 0) ?></H5>
                            </div>
                        </div>
                    </div>
                </div>
